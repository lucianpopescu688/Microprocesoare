...
void MyCallback(DMA_HandleTypeDef *_hdma);
...
int main(void)
{
  ...
  HAL_DMA_RegisterCallback(&hdma_memtomem_dma2_stream4, HAL_DMA_XFER_CPLT_CB_ID, &MyCallback);
  ...
  while (1)
  {
//	  HAL_DMA_Start(&hdma_memtomem_dma2_stream4, (uint32_t)&Source[1], (uint32_t)&GPIOA->ODR, 1);	// LED = ON
//	  HAL_DMA_PollForTransfer(&hdma_memtomem_dma2_stream4, HAL_DMA_FULL_TRANSFER, HAL_MAX_DELAY);
//	  HAL_Delay(300);
//
//	  HAL_DMA_Start(&hdma_memtomem_dma2_stream4, (uint32_t)&Source[0], (uint32_t)&GPIOA->ODR, 1);   // LED = OFF
//	  HAL_DMA_PollForTransfer(&hdma_memtomem_dma2_stream4, HAL_DMA_FULL_TRANSFER, HAL_MAX_DELAY);
//	  HAL_Delay(300);


	  HAL_DMA_Start_IT(&hdma_memtomem_dma2_stream4, (uint32_t)&Source[1], (uint32_t)&GPIOA->ODR, 1);	// LED = ON
	  //HAL_DMA_PollForTransfer(&hdma_memtomem_dma2_stream4, HAL_DMA_FULL_TRANSFER, HAL_MAX_DELAY);
	  HAL_Delay(100);

	  HAL_DMA_Start_IT(&hdma_memtomem_dma2_stream4, (uint32_t)&Source[0], (uint32_t)&GPIOA->ODR, 1);   // LED = OFF
	  //HAL_DMA_PollForTransfer(&hdma_memtomem_dma2_stream4, HAL_DMA_FULL_TRANSFER, HAL_MAX_DELAY);
	  HAL_Delay(100);
